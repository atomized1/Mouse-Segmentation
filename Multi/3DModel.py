        ...
        for y in range(0, len(mask[0])):
            for z in range(0, len(mask[0, 0])):
                for a in range(0, len(mask[0, 0, 0])):
                    ...
                    elif mask[x,y,z,a] == 51:
                        new[3] = 0
                        newTruth[x,y,z,a] = new
                    elif mask[x,y,z,a] == 64:
                        new[4] = 0
                        newTruth[x,y,z,a] = new
                    elif 1 <= mask[x,y,z,a] <= 50 or 52<= mask[x,y,z,a] <= 63 or 65 <= mask[x,y,z,a] <= 68 or (129 >= mask[x, y, z, a] >= 118) or mask[x, y, z, a] == 131 or mask[x, y, z, a] == 151 or (
