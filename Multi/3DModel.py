...
def main():
    ...
    dconv3a = keras.layers.Conv3DTranspose(filters=96, kernel_size=(3, 3, 3), padding='same')(conv3b)
    dconv3b = keras.layers.Conv3DTranspose(filters=96, kernel_size=(3, 3, 3), padding='same')(dconv3a)
    unpool2 = keras.layers.UpSampling3D(size=(2, 2, 2))(dconv3b)
    cat2 = keras.layers.concatenate([conv2b, unpool2])
    dconv2a = keras.layers.Conv3DTranspose(filters=96, kernel_size=(3, 3, 3), padding='same')(cat2)
    dconv2b = keras.layers.Conv3DTranspose(filters=96, kernel_size=(3, 3, 3), padding='same')(dconv2a)
